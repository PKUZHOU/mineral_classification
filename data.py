...
def create_dataset():
    ori_root = '/home/zhou/mineral_data/data'
    root = '/home/zhou/mineral_data'
    train_dir = '/home/zhou/mineral_data/train'
    val_dir = '/home/zhou/mineral_data/val'
    minerals_cnt = {}
    image_paths = {}
...
if __name__ == '__main__':
    create_dataset()
    # data = MyDataset('/home/zhou/mineral_data/trainval',train=True)
    # image,label = data[3]
    # print image.shape
    # print label
    # print data.labels
